...
export function AlmaLogo({ className = '', size = 128 }: AlmaLogoProps) {
  return (
    <svg
      ...
      height={size}
      role="img"
      aria-labelledby="alma-logo-title alma-logo-desc"
      className={className}
    >
      <title id="alma-logo-title">Cute Alma Icon</title>
      <desc id="alma-logo-desc">Cute, pink, female-friendly Alma logo: rounded brain/leaf character with big eyes, blush, and seed accent</desc>
